...
namespace Project18_SuperStoreDashboardProject
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection sqlConnection = new SqlConnection("Server=DESKTOP-Q270QVE\\SQLEXPRESS; initial catalog=DbSuperstore; integrated security= true");
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            while (reader3.Read())
            {
                lblOrderCountByTurkey.Text = reader3[0].ToString();
            }
            sqlConnection.Close();
